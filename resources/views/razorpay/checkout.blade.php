                ...
                <div class="hide" style="display:none">
                    ...
                    'invoice_uid' => $invoice->uid,
                        ...
                        <script
                            ...
                            {{-- data-image="{{ \Acelle\Model\Setting::get('site_logo_small') ? \hoursefly\Cashier\Cashier::lr_action('SettingController@file', \Acelle\Model\Setting::get('site_logo_small')) : URL::asset('images/default_site_logo_small_' . (Auth::user()->customer->getColorScheme() == "white" ? "dark" : "light") . '.png') }}" --}}
