...
class StripePaymentGateway implements PaymentGatewayInterface
{
    ...
    {
        return action("\hoursefly\Cashier\Controllers\StripeController@settings");
    }

    public function getAutoBillingDataUpdateUrl($returnUrl='/') : string
    {
        return \hoursefly\Cashier\Cashier::lr_action("\hoursefly\Cashier\Controllers\StripeController@autoBillingDataUpdate", [
    ...
    {
        return action("\hoursefly\Cashier\Controllers\StripeController@checkout", [
