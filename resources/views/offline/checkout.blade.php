...
@section('page_header')
    ...
    <div class="page-title">
        <ul class="breadcrumb breadcrumb-caret position-right">
            <li class="breadcrumb-item"><a href="{{ \hoursefly\Cashier\Cashier::lr_action("HomeController@index") }}">{{ trans('messages.home') }}</a></li>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="d-flex align-items-center">
                <form method="POST"
                    action="{{ \hoursefly\Cashier\Cashier::lr_action('\hoursefly\Cashier\Controllers\OfflineController@claim', [
