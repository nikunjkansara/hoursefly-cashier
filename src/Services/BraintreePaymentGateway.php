...
class BraintreePaymentGateway implements PaymentGatewayInterface
{
    ...
    {
        return action("\hoursefly\Cashier\Controllers\BraintreeController@settings");
    }
    ...
    {
        return \hoursefly\Cashier\Cashier::lr_action("\hoursefly\Cashier\Controllers\BraintreeController@checkout", [
    ...
    {
        return \hoursefly\Cashier\Cashier::lr_action("\hoursefly\Cashier\Controllers\BraintreeController@autoBillingDataUpdate", [
