...
use hoursefly\Cashier\Library\CoinPayment\CoinpaymentsAPI;
...
class CoinpaymentsPaymentGateway implements PaymentGatewayInterface
{
    ...
    {
        return action("\hoursefly\Cashier\Controllers\CoinpaymentsController@settings");
    }

    public function getCheckoutUrl($invoice) : string
    {
        return action("\hoursefly\Cashier\Controllers\CoinpaymentsController@checkout", [
