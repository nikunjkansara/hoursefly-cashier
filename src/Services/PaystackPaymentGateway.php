...
class PaystackPaymentGateway implements PaymentGatewayInterface
{
    ...
    {
        return action("\hoursefly\Cashier\Controllers\PaystackController@settings");
    }
    ...
    {
        return \hoursefly\Cashier\Cashier::lr_action("\hoursefly\Cashier\Controllers\PaystackController@autoBillingDataUpdate", [
    ...
    {
        return \hoursefly\Cashier\Cashier::lr_action("\hoursefly\Cashier\Controllers\PaystackController@checkout", [
